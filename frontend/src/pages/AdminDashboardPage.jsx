...
const MonitoringIndonesiaMap = () => (
  <div className="superadmin-monitoring-map-frame">
    ...
    >
      <defs>
        <linearGradient id="superadminMonitoringMapFill" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#6b4b3a" stopOpacity="0.24" />
          <stop offset="100%" stopColor="#b88730" stopOpacity="0.18" />
        </linearGradient>
      </defs>

      <g className="superadmin-monitoring-map-shadow">
        <path d="M118 129c-28 6-49 28-55 57-7 32 8 61 33 85 21 20 39 45 51 74 8 19 24 23 39 11 16-13 17-38 10-61-8-28-4-51 13-72 14-18 23-39 18-59-8-27-48-43-109-35Z" />
        <path d="M336 115c-35 10-63 37-73 73-10 34-1 71 27 100 33 34 84 45 127 27 44-18 80-62 86-104 5-39-13-75-47-96-33-21-77-21-120 0Z" />
        <path d="M539 111c19-11 43-12 63-2 17 9 22 25 14 43l-12 25 21 18c20 17 27 40 18 61-8 19-28 28-49 23l-23-7-17 27c-11 19-31 28-50 20-20-9-27-28-18-49l12-25-18-16c-18-16-22-36-12-54 11-20 33-27 56-19l21 7 13-21c7-11 17-23 31-31Z" />
        <path d="M708 157c39-24 101-31 157-18 45 10 76 35 86 69 8 30-3 59-34 87-31 28-70 45-117 50-46 5-84-6-114-32-29-25-43-56-40-87 4-31 25-53 62-69Z" />
        <path d="M271 303c43-8 111-11 174-8 35 2 55 8 57 17 3 12-15 21-52 25-64 7-180 8-221 2-22-3-33-10-33-20 0-8 8-13 23-16 14-3 32-6 52-7Z" />
        <ellipse cx="507" cy="315" rx="18" ry="8" />
        <ellipse cx="546" cy="321" rx="20" ry="7" />
        <ellipse cx="586" cy="325" rx="18" ry="6.5" />
        <ellipse cx="624" cy="328" rx="17" ry="6" />
        <ellipse cx="653" cy="259" rx="12" ry="8" />
        <ellipse cx="677" cy="237" rx="11" ry="7" />
        <ellipse cx="694" cy="261" rx="10" ry="7" />
        <ellipse cx="719" cy="243" rx="9" ry="6" />
      </g>

      <g className="superadmin-monitoring-map-islands">
        <path d="M118 129c-28 6-49 28-55 57-7 32 8 61 33 85 21 20 39 45 51 74 8 19 24 23 39 11 16-13 17-38 10-61-8-28-4-51 13-72 14-18 23-39 18-59-8-27-48-43-109-35Z" />
        <path d="M336 115c-35 10-63 37-73 73-10 34-1 71 27 100 33 34 84 45 127 27 44-18 80-62 86-104 5-39-13-75-47-96-33-21-77-21-120 0Z" />
        <path d="M539 111c19-11 43-12 63-2 17 9 22 25 14 43l-12 25 21 18c20 17 27 40 18 61-8 19-28 28-49 23l-23-7-17 27c-11 19-31 28-50 20-20-9-27-28-18-49l12-25-18-16c-18-16-22-36-12-54 11-20 33-27 56-19l21 7 13-21c7-11 17-23 31-31Z" />
        <path d="M708 157c39-24 101-31 157-18 45 10 76 35 86 69 8 30-3 59-34 87-31 28-70 45-117 50-46 5-84-6-114-32-29-25-43-56-40-87 4-31 25-53 62-69Z" />
